...
export const DEFAULT_LAYOUT_LG: Layout = applyConstraints([
  ...
  item('flows',         7, 36, 5, 8),
  item('retail-organic',0, 46, 8, 9),
  item('collar',        8, 46, 4, 8),
])
...
export const DEFAULT_LAYOUT_MD: Layout = applyConstraints([
  ...
  item('flows',         6, 42, 4, 8),
  item('retail-organic',0, 51, 10, 8),
  item('collar',        0, 59, 10, 6),
])
...
export const DEFAULT_LAYOUT_SM: Layout = applyConstraints([
  ...
  item('flows',         0, 68, 6, 7),
  item('retail-organic',0, 75, 6, 9),
  item('collar',        0, 84, 6, 7),
])
...
export const DEFAULT_LAYOUT_XS_SIMPLE: Layout = applyConstraints([
  ...
  item('flows',         0, 75, 4, 7),
  item('retail-organic',0, 82, 4, 10),
  item('collar',        0, 92, 4, 7),
])
